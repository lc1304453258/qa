...
module.exports = {
    ...
    methods: {
        ...
        stockOutCheck: function () {
            ...
            if (updateIventoryInstanceDtos.length > 0 && _self.isRequire ==
                false) {
                _self.isRequire = true;
                if (_self.stockOutPrepareId == undefined) {
                    _self.stockOutPrepareId = 0;
                }
        ...
        matchingLeftTabData: function (data) {
            var _self = this;
            if (_self.inventoryStockOutDtoList.length <= 0) {
                return;
            }
        ...
        scanRack: function () {
            ...
            if (updateIventoryInstanceDtos != null && updateIventoryInstanceDtos.length > 0) {
                ...
                StockOutGeneratorResource.stockOutByComponent(updateIventoryInstanceDtos, currentDate, _self.stockOutPrepareId, _self.tagNo).then(
                    successData => {
                        Loading.hide(uuid);
