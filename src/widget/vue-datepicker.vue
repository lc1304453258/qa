<template>
  <div class="cov-vue-date">
    <div class="datepickbox">
      <input type="text" title="input date" class="form-control cov-datepicker" :readonly="readonly" :disabled="readonly" :placeholder="option.placeholder" v-model="date.time" :required="required" @click="showCheck" @foucus="showCheck" :style="option.inputStyle ? option.inputStyle : {}" :class="{'cov-vue-date-disabled': readonly}"/>
    </div>
...
exports.default = {
  ...
  methods: {
    ...
    showDay: function showDay(time) {
      if (time === undefined || !(time._d instanceof Date)) {
