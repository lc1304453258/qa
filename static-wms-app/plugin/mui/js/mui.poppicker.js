 ...
 * by Houfeng
 * Houfeng@DCloud.io
 * Update By HaoYanbing 20171213 添加数据过滤功能
 */
...
(function($, document) {
	...
	var panelBuffer = '<div class="mui-poppicker">\
		<div class="mui-poppicker-header" style="text-align:center">\
			...
			<input style="height:30px;width:60%;color:black;margin-bottom:0px;" type="text" class="mui-poppicker-input" placeholder="查询..."></input>\
