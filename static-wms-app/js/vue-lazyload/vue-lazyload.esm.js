...
var loadImageAsync = function loadImageAsync(item, resolve, reject) {
  if (!axios) {
    throw new Error('[vue-lazyload] cannot locate Axios');
  }
  ...
  if (item.src.indexOf("data:image") == 0) {
    ...
    axios({
      ...
      var imgBase64 = null;
      if (window.Buffer == undefined || window.Buffer == null) {
        imgBase64 = arrayBufferToBase64(resp.data);
      } else {
        imgBase64 = new Buffer(resp.data, 'binary').toString('base64');
      }
      image.src = 'data:' + mimeType + ';base64,' + imgBase64;
    }).catch(function (e) {
      // image.src = imageUrl;
      reject(e);
    });
    ...
    value: function load() {
      ...
      this.renderLoading(function () {
        ...
        loadImageAsync({
          ...
          _this3.src = data.src;
          _this3.srcUrl = data.srcUrl;
          _this3.state.loaded = true;
          _this3.state.error = false;
          _this3.record('loadEnd');
          _this3.render('loaded', false);
          _this3.state.rendered = true;
          _this3._imageCache.add(_this3.srcUrl);
          onFinish();
        }, function (err) {
